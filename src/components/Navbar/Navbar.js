  ...
  return (
    <header className="Home-header d-flex justify-content-between align-items-center p-3 border">
      ...
      <div className="auth-buttons">
        <button className="btn btn-outline-primary me-2" onClick={handleClick}>Criar Evento</button>
        <button className="btn btn-primary" onClick={handleClickRegistrar}>Registrar</button>
      </div>
    </header>
  );
}
